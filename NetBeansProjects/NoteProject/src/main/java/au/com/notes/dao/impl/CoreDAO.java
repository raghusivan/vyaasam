package au.com.notes.dao.impl;

import static au.com.notes.constants.DelimiterConstants.BACK_SLASH;
import static au.com.notes.constants.DelimiterConstants.FULLSTOP;
import static au.com.notes.constants.DelimiterConstants.PERCENT;
...
import com.note.beans.IBaseEntity;
...
public class CoreDAO<T> {
    ...
    /**
     * Stores an instance of the entity class in the database merge in JPA is
     * similar to saveOrUpdate in hibernate
     *
     * @param T Object
     * @return
     */
    ...
    /**
     * This method uses TypedQuery to return the number of records that meet the
     * criteria with parameter map and result limit
     *
     * @param queryString
     * @param clazz
     * @param parameters
    ...
    /**
     * Stores an instance of the entity class in the database merge in JPA is
     * similar to saveOrUpdate in hibernate with indicating whether to flush or
     * not
     *
     * @param T Object
     * @return
    ...
    /**
     * Reload the object from the database, reflects changes of the external
     * source.
     *
     * @param t
     * @return
     ...
     *
     * TODO: This method, and associated test cases, should be moved to
     * BooktopiaUtils.DatabaseUtils
     *
     * @param text
     * @return
     */
